...
public class WebUtil {
    ...
    public static Map<Object, Object> getRequestParamMap(HttpServletRequest request) {
        Map<Object, Object> paramMap = new LinkedHashMap<Object, Object>();
        ...
        try {
            for (Object key : requestParameterMap.keySet()) {
                ...
                paramMap.put(key, CodecUtil.urlDecode(StringUtils.trim(value)));
            }
