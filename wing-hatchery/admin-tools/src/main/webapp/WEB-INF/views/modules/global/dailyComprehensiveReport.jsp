...
<body>
	...
	<table id="contentTable" class="datatable table table-striped table-bordered table-condensed" style="overflow: scroll">
		...
		<tr><th>日期</th><th>开服数</th><th>收入</th><th>新增注册数</th><th>活跃用户</th><th>老用户</th><th>ACCU</th><th>PCCU</th><th>DT时长(分)</th><th>充值人数</th>
			<th>充值次数</th><th>付费率</th><th>ARPU</th><th>活跃ARPU</th><th>首充人数</th><th>首充金额</th><th>日首充次数</th><th flex="true">新新充值人数</th><th flex="true">新新充值金额</th><th flex="true">新新充值次数</th><th flex="true">新新付费率</th><th>新新ARPU</th>
			<th>老新充值人数</th><th>老新充值金额</th><th>老新充值次数</th><th>老新付费率</th><th>老新ARPU</th><th>老老充值人数</th><th>老老充值金额</th><th>老老充值次数</th><th>老老付费率</th><th>老老ARPU</th></tr>
		</thead>
		<tbody>
	...
	<table id="weekReport" class="datatable table table-striped table-bordered table-condensed" style="overflow: scroll">
		<thead>
			<th>周</th><th>时间段</th><th>周开服</th><th>周收入</th><th>周新增注册</th><th>周活跃</th><th>周老用户</th>
			<th>周充值用户</th><th>付费率</th><th>ARPU</th><th>周活跃ARPU</th><th>新新充值人数</th><th>新新充值金额</th><th>周新新付费率</th>
			<th>周新新ARPU</th><th>周老充值人数</th><th>周老充值金额</th><th>周老付费率</th><th>周老ARPU</th>
		</thead>
		<tbody>
