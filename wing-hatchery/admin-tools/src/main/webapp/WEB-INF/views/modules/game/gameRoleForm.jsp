...
<body>
	...
	<div class="panel panel-primary">
		...
		<table id="contentTable" class="table table-striped table-bordered table-condensed">
			<tr>
				<th>玩家账号</th><td>${role.roleId}</td>
				<th>角色名</th><th>${role.roleName}</th>
				<th>职业</th><td>${role.job}</td>
				<th>性别</th><th>${role.gender}</th>
			</tr>
			<tr>
				<th>等级</th><td>${role.level}</td>
				<th>玩家战斗力</th><td>${role.power}</td>
				<th>累计充值金额</th><td>${role.leiji_jine}</td>
				<th>VIP等级</th><td>无</td>
			</tr>
			<tr>
				<th>元宝</th><td>${role.diamond}</td>
				<th>绑定元宝</th><td>${role.bind_diamond}</td>
				<th>游戏币</th><td>${role.coin}</td>

			</tr>
			<tr>
				<th>帮派</th><td>${role.guild_name}</td>
				<th>帮派职位</th><td>${role.position}</td>

			</tr>
			<tr>
				<th>创建时间</th><td>${role.add_time}</td>
				<th>最后登陆时间</th><td>${role.lastLoginTime}</td>
				<th>最后离线时间</th><td>${role.lastLogoutTime}</td>
				<th>最后充值时间</th><td>${role.lastChargeTime}</td>
			</tr>
		</table>
	</div>
	<div class="panel panel-primary">
		...
		<table id="friendsTable" class="table table-striped table-bordered table-condensed">
			<tr><th>用户账号</th><th>角色名</th><th>职业</th><th>性别</th><th>等级</th></tr>
	...
	<div class="panel panel-primary">
		...
		<table id="itemsTable" class="table table-striped table-bordered table-condensed">
			<tr><th>部位</th><th>装备名称</th><th>装备等级</th><th>装备品质</th><th>装备强化</th><th>装备星级</th><th>镶嵌宝石</th></tr>
	...
	<div class="panel panel-primary">
		...
		<table id="horseTable" class="table table-striped table-bordered table-condensed">
			<tr><th>最大等级</th><th>当前等级</th><th>获得时间</th><th>更新时间</th></tr>
