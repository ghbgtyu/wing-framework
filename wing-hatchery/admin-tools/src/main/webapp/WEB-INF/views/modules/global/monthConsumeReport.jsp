...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/global/rechargeConsume/monthConsumeReport">月消费统计</a></li>
	</ul>
...
<div class="row-fluid">
			<div class="span12 panel panel-primary">
				<div class="panel-heading">每月消费总计</div>
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th>日期</th><th>开服数</th><th>收入</th><th>新注册</th><th>活跃用户</th><th>老用户数</th><th>消费用户</th><th>消费次数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费活跃ARPU</th><th>首消费人数</th><th>首消费金额</th></tr>
		...
		<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th>日期</th><th>总收入</th><th>新服活跃</th><th>新服消费人数</th><th>新服消费金额</th><th>新服付费率</th><th>新服ARPU</th><th>老服活跃</th><th>老服消费人数</th><th>老服消费金额</th><th>老服消费率</th><th>老服消费ARPU</th></tr>
					<c:forEach items="${monthList}" var="item">
						<tr>
							<td>${item.log_month}</td>
							<td>${item.amount}</td>
		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				<div class="panel-heading">平台消费数据对比</div>
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
