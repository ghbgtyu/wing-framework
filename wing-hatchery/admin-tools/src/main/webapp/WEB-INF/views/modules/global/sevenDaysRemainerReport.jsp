...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th>注册日期</th> <th>注册用户数</th> <th>次日用户</th> <th>次日留存</th> <th>3日用户</th>
			<th>3日留存</th> <th>4日用户</th> <th>4日留存</th> <th>5日用户</th> <th>5日留存</th>
			<th>6日用户</th> <th>6日留存</th> <th>7日用户</th> <th>7日留存</th>
		</tr>
		</thead>
		<tbody>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th>注册日期</th> <th>新服用户</th> <th>次日留存率</th> <th>3日留存率</th> <th>4日留存率</th>
			<th>5日留存率</th> <th>6日留存率</th> <th>7日留存率</th> <th>老服用户</th> <th>次日留存率</th>
			<th>3日留存率</th> <th>4日留存率</th> <th>5日留存率</th> <th>6日留存率</th> <th>7日留存率</th>
		</tr>
		</thead>
		<tbody>
		<c:forEach items="${sevenDaysRemainer}" var="item">
