		...
		<div class="row-fluid">
			...
			<div class="span6 panel panel-primary">
				...
				<table id="platformActiveSTAT" class="table table-striped table-bordered table-condensed">
					<tr><th>时间段</th><th>平台名</th><th>平台活跃</th><th>占比</th><th>环比（前）</th><th>环比（后）</th>
					<th>去新活跃</th><th>占比</th><th>环比（前）</th><th>环比（后）</th>
					</tr>
					<c:forEach items="${activeStatisticsList}" var="item">
						<tr>
		...
		<div class="row-fluid">
			...
			<div class="span6 panel panel-primary">
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th colspan="5"></th><th colspan="5" style="text-align: center">去新活跃用户构成</th>
					</tr>
					<tr><th>时间段</th><th>平台名</th><th>活跃用户</th><th>新用户</th><th>去新用户(老用户)</th><th>免费用户</th>
					<th>【0,100】</th><th>【100,1000】</th><th>【1000，10000】</th><th>【10000+】</th>
					</tr>
					<c:forEach items="${activeStatisticsList}" var="item">
						<tr>
							<td>${fn:substring(paramMap.createDateStart,"5","10")}~${fn:substring(paramMap.createDateEnd,"5","10")}</td>
