...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<tr><th>配置文件名</th><th>原始文件名</th><th>文件描述</th><th>文件类型</th><th>创建时间</th><th>更新时间</th><th>操作</th></tr>
		<c:forEach items="${page.list}" var="configFile">
			<tr>
				...
				<td>
                    ...
                    <a href="${ctx}/tools/gameConfig/delete?id=${configFile.id}" onclick="return confirmx('确认要删除吗？', this.href)">删除</a>
				</td>
			</tr>
		</c:forEach>
	</table>
