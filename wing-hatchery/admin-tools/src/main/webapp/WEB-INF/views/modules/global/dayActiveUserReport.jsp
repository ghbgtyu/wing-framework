		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				...
				<table id="contentTable" class="table table-striped table-bordered table-condensed">
					<thead>
					<tr><th>日期</th> <th>服务器总数</th> <th>活跃总数</th>
					</tr>
					</thead>
					<tbody>
			...
			<div class="span6 panel panel-primary">
				...
				<table id="contentTable" class="table table-striped table-bordered table-condensed">
					<thead>
					<tr><th>日期</th> <th>平台名 </th> <th>服务器 </th><th>日活跃用户数 </th>
					</tr>
					</thead>
					<tbody>
	...
	<div class="container-fluid">
		<div class="row-fluid">
				...
				<div style="height: 300px;line-height: 300px">
					...
					<table class="highchart table"
						   data-graph-container=".highchart-monthActive" data-graph-type="spline" data-graph-xaxis-reversed="1"
						   data-graph-yaxis-1-title-text = '活跃人数' style="display: none">
