...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/global/platformRechargeConsume/platformRechargeTimePeriod">平台充值时段统计</a></li>
	...
	<form id="searchForm" action="${ctx}/global/platformRechargeConsume/platformRechargeTimePeriod" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th>日期</th>	<th>平台</th>	<th>0:00:00</th>	<th>1:00:00</th>	<th>2:00:00</th>
		...
		<tbody>
		<c:forEach items="${platformRechargeTimePeriod.list}" var="item">
			<tr>
				<td>${item.log_day}</td>
	...
	<div class="pagination">${platformRechargeTimePeriod}</div>
