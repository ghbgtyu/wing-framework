...
<html>
<head>
	<title>日消费统计（绑定元宝）</title>
	<meta name="decorator" content="default"/>
	<%@include file="/WEB-INF/views/include/highcharts.jsp" %>
</head>
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/global/rechargeConsume/dailyBindConsumeReport">日消费统计（绑定元宝）</a></li>
	</ul>
...
<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th>日期</th><th>开服数</th><th>绑定总量</th><th>绑定产出</th><th>消费金额</th><th>新增注册数</th><th>活跃用户</th><th>消费人数</th><th>消费次数</th><th>消费率</th><th>消费ARPU</th><th>活跃ARPU</th><th>首消费人数</th><th>首消费金额</th></tr>
		...
		<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					...
					<tr><th>日期</th><th>收入</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费ARPU</th></tr>
					<c:forEach items="${dailyList}" var="item">
						<tr>
							<td>${item.log_day}</td>
							<td>${item.amount}</td>
		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th>日期</th><th>平台</th><th>活跃人数</th><th>绑定总量</th><th>绑定产出</th><th>消费人数</th><th>消费金额</th><th>消费率</th><th>消费APRU</th><th>活跃APRU</th></tr>
