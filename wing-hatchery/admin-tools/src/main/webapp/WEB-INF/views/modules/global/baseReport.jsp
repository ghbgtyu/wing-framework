		...
		<div class="row-fluid">
			<div class="span6 panel panel-primary">
				...
				<table id="dailyTable" class="table table-striped table-bordered table-condensed">
					<tr><th>日期</th><th>新增注册数</th><th>活跃用户</th><th>收入</th><th>付费人数</th><th>平均在线</th><th>最高在线</th><th>付费率</th><th>ARPU</th></tr>
			...
			<div class="span6 panel panel-primary">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
					<table id="overallTable" class="table table-striped table-bordered table-condensed">
						<tr><th>日期</th><th>累计开服</th><th>累计收入</th><th>累计新进</th><th>累计付费人数</th></tr>
			...
			<div class="span6 panel panel-primary">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
					<table id="totalData" class="table table-striped table-bordered table-condensed">
						<tr>
							<th>日期</th><th>收入</th><th>新注册</th><th>活跃用户数</th><th>月留存</th>
							<th>ACCU</th><th>PCCU</th><th>付费人数</th><th>付费率(%)</th><th>ARPU</th><th>活跃ARPU</th>
						</tr>
					...
					<table class="highchart table"
						...
						<c:forEach items="${mapList}" var="item">
							<tr>
								...
								<td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_income_percent}"/>"><fmt:formatNumber type="percent" value="${item.p_income_percent}"/></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
				...
				<div style="height: 300px;line-height: 300px">
					...
					<table class="highchart table"
						...
						<c:forEach items="${mapList}" var="item">
							<tr>
								<td>${fns:getGamePlatformNameById(item.pid,item.pid)}</td>
								<td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_dau_percent}"/>"><fmt:formatNumber type="percent" value="${item.p_dau_percent}"/></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
				...
				<div style="height: 300px;line-height: 300px">
					...
					<table class="highchart table"
						...
						<c:forEach items="${mapList}" var="item">
							<tr>
								<td>${fns:getGamePlatformNameById(item.pid,item.pid)}</td>
								<td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_dru_percent}"/>"><fmt:formatNumber type="percent" value="${item.p_dru_percent}"/></td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
			...
			<div class="span6 panel panel-primary">
				...
				<div class="" style="width:100%;height:300px;line-height:300px;overflow:auto;overflow-x:hidden;">
					<table id="platformTable" class="table table-striped table-bordered table-condensed">
						<tr><th>时间段</th><th>平台名</th><th>平台收入</th><th>占比</th><th>平台活跃</th><th>占比</th><th>平台导量</th><th>占比</th></tr>
						<c:forEach items="${mapList}" var="item">
							<tr>
