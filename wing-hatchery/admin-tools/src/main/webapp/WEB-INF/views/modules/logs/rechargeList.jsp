...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<tr><th width="18px"><input id="checkAllOrNot" name="checkAllOrNot" type="checkbox"></th><th>用户账号</th><th>角色账号</th><th>角色名</th><th>订单号</th><th>充值类型</th><th>货币类型</th>
			<th>充值金额</th><th>充值元宝</th><th>充值状态</th><th>充值时间</th></tr>
