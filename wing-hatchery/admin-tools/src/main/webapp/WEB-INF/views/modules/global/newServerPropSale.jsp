...
<body>
	...
	<form id="searchForm" action="${ctx}/global/tradeController/propSale?stype=1" method="post" class="breadcrumb form-search">
	...
	<table id="active-yb" class="table table-striped table-bordered table-condensed">
		<tr><th>时间段</th><th>商店类型</th><th>物品名称</th><th>物品ID</th><th>数量</th><th>总消耗金额</th><th>占比(%)</th>
			<th>元宝消耗金额</th><th>消费人数</th><th>消费次数</th><th>绑元消费金额</th><th>绑元消费人数</th><th>绑元消费次数</th></tr>
