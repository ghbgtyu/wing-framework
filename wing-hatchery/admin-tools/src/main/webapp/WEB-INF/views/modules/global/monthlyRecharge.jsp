...
<body>
	...
	<div class=" panel panel-primary">
		...
		<table id="contentTable" class="datatable table table-striped table-bordered table-condensed" style="overflow: scroll">
			<thead>
			<tr><th>月份</th><th>开服数</th><th>收入</th><th>新注册</th><th>活跃用户</th><th>老用户数</th><th>充值用户</th><th>充值次数</th><th>付费率</th><th>ARPU</th>
				<th>活跃ARPU</th><th>首充人数</th><th>首充次数</th><th>首充金额</th><th>新新充值人数</th><th>新新充值次数</th><th>新新充值金额</th><th>新新付费率</th><th>新新ARPU</th><th>老充值人数</th><th>老充值次数</th><th>老充值金额</th>
				<th>老付费率</th><th>老ARPU</th>
			</tr>
			</thead>
			<tbody>
	...
	<div class=" panel panel-primary" >
		...
		<table id="contentTable" class="datatable table table-striped table-bordered table-condensed" style="overflow: scroll">
			<thead>
			<tr><th>月份</th><th>总收入</th><th>新服活跃</th><th>新服充值人数</th><th>新服充值次数</th><th>新服充值金额</th><th>新服付费率</th><th>新服ARPU</th>
			<th>老服活跃</th><th>老服充值人数</th><th>老服充值次数</th><th>老服充值金额</th><th>老服付费率</th><th>老服ARPU</th>
			</tr>
			</thead>
			<tbody>
	...
	<div class=" panel panel-primary">
		...
		<table id="contentTable" class="datatable table table-striped table-bordered table-condensed" style="overflow: scroll">
			<thead>
			<tr><th>月份</th><th>平台</th><th>活跃用户</th><th>充值人数</th><th>充值次数</th><th>充值金额</th><th>付费率</th><th>ARPU</th><th>活跃ARPU</th>
			</tr>
			</thead>
			<tbody>
