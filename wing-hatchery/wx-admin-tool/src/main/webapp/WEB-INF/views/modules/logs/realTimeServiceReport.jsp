...
<form id="searchForm" action="${ctx}/log/realTimeService/realTimeServiceReport" method="post"
    ...
    <input name="createDateStart" id="createTimeStart" maxlength="50" value="${paramMap.createDateStart}"
           class="input-small required" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH'})"/>
