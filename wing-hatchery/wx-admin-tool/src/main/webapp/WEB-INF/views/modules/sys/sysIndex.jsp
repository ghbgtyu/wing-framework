            ...
            top.$.jBox.open("iframe:${ctx}/tools/gameArea/selectSingleGameServer", "选择游戏服务器(单选)", 810, $(top.document).height() - 240, {
                buttons: {"确定": "ok", "关闭": true}, bottomText: "通过选择平台，查询出游戏服务器。", submit: function (v, h, f) {
                    ...
                    if (v == "ok") {
                        ...
                        _remoteCall("${ctx}/tools/gameArea/changeGameServer", {
                            gameServerId: selectedGameServerId,
                            gameServerName: selectedGameServerName
                        }, function (result) {
                            if (result.success) {
                    ...
                    <c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
                        <c:if test="${menu.parent.id eq '1' && menu.isShow eq '1'}">
                            <li class="menu ${firstMenu ? ' active' : ''}"><a class="menu"
                                                                              ...
                                                                              target="menuFrame"><spring:message
                                    code="${menu.internationalKey}"/></a></li>
                            <c:if test="${firstMenu}">
                ...
                <ul class="nav pull-right">
                    ...
                    <li id="themeSwitch" class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#"
                           title="<spring:message code='theme.switch'/>"><i class="icon-th-large"></i></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息"><spring:message
                                code="Hello"/> , <shiro:principal property="loginName"/></a>
                        <ul class="dropdown-menu">
                            <li><a href="${ctx}/sys/user/info" target="mainFrame"><i class="icon-user"></i>&nbsp;
                                <spring:message code="person.info"/></a></li>
                            <li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;
                                <spring:message code="modify.passwod"/></a></li>
                        </ul>
                    </li>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid">
            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a
                href="https://github.com/mokylin/cabal" target="_blank">Cabal</a> ${fns:getConfig('version')}
