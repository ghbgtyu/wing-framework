...
<body>
	...
	<form id="searchForm" action="${ctx}/global/tradeController/resLineDistribution" method="post" class="breadcrumb form-search">
		...
		<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<table id="resLine" class="table table-striped table-bordered table-condensed">
					<tr><th>时间段</th><th>消费项</th><th>元宝消耗</th><th>消耗占比(%)</th><th>消费人数</th><th>人数占比(%)</th></tr>
		...
		<div class="row-fluid">
			<div class="span12 panel panel-primary">
				...
				<table id="band-yb" class="table table-striped table-bordered table-condensed">
					<tr><th>时间段</th><th>消费项</th><th>绑定元宝消耗</th><th>消耗占比(%)</th><th>消费人数</th><th>人数占比(%)</th></tr>
					<c:forEach items="${reslist}" var="item">
						<tr>
							<tr>
							<td>${createDateStart } ~ ${createDateEnd }</td>
