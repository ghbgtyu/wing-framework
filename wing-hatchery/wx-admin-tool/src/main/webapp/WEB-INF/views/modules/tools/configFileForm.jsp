...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a
            href="${ctx}/tools/gameConfig/form?id=${configFile.id}">${not empty configFile.id?'修改':'添加'}配置</a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="configFile" action="${ctx}/tools/gameConfig/save" method="post"
