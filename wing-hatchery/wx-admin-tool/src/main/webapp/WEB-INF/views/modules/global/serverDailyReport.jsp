...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
		<tr><th>日期</th> <th>收入</th> <th>新增注册数</th> <th>活跃用户</th> <th>老用户</th> <th>ACCU</th> <th>PCCU</th> <th>DT时长(分)</th>
			<th>充值人数</th><th>充值次数</th> <th>付费率</th> <th>ARPU</th> <th>活跃ARPU</th> <th>首充人数</th><th>首充次数</th> <th>首充金额</th> <th>新注册次日留存</th>
			<th>新注册3日留存</th> <th>新注册7日留存</th> <th>新注册双周留存</th> <th>新注册月留存</th>
		</tr>
		</thead>
		<tbody>
			...
			<div class="span6 panel panel-primary">
				...
				<div style="height: 300px;line-height: 300px">
					...
					<table class="highchart table"
						   ...
						   data-graph-yaxis-1-title-text = '人数' data-graph-zoom-type="xy" data-graph-yaxis-2-opposite="1" style="display: none">
