...
<head>
    ...
    <style type="text/css">
        ...
        .SortAscCss {
            background-image: url(${ctxStatic}/images/Asc.gif);
            background-repeat: no-repeat;
            background-position: right center;
        }
    </style>
...
<form id="searchForm" action="${ctx}/global/rechargeConsume/rechargeConsumeRanking" method="post"
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable1" class="datatable table table-striped table-bordered table-condensed"
        ...
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable2" class="datatable table table-striped table-bordered table-condensed"
                   style="overflow: scroll">
                <thead>
                <tr>
                    <th>时间段</th>
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable3" class="datatable table table-striped table-bordered table-condensed"
                   style="overflow: scroll">
                <thead>
                <tr>
                    <th>时间段</th>
        ...
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable4" class="datatable table table-striped table-bordered table-condensed"
                   style="overflow: scroll">
                <thead>
                <tr>
                    <th>时间段</th>
...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable5" class="datatable table table-striped table-bordered table-condensed"
                   style="overflow: scroll">
                <thead>
                <tr>
                    <th>时间段</th>
        ...
        <div class="span6 panel panel-primary">
            ...
            <table id="contentTable6" class="datatable table table-striped table-bordered table-condensed"
                   style="overflow: scroll">
                <thead>
                <tr>
                    <th>时间段</th>
