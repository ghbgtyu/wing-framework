...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="game.recharge.apply">
			<li><a href="${ctx}/tools/recharge/form?id=${recharge.id}">${not empty recharge.id?'按角色名修改':'按角色名申请'}充值</a></li>
			<li class="active"><a href="${ctx}/tools/recharge/roleIdRechargeForm?id=${recharge.id}">${not empty recharge.id?'按角色ID修改':'按角色ID申请'}充值</a></li>
		</shiro:hasPermission>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="recharge" action="${ctx}/tools/recharge/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <form:textarea path="roleIds"  htmlEscape="false" rows="3" maxlength="200" class="input-xxlarge required"/>
