...
<form id="searchForm" action="${ctx}/global/rechargeConsume/monthBindConsumeReport" method="post"
    ...
    <input name="createDateStart" id="createDateStart" maxlength="50" value="${paramMap.createDateStart}"
           class="input-small required" readonly="readonly" onclick="selectMonth()"/>
    -
    <input name="createDateEnd" maxlength="50" class="input-small required" value="${paramMap.createDateEnd}"
           readonly="readonly" onclick="selectMonth()"/>
    <label>平台 ：</label>
