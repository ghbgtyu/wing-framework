...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="game.email.edit">
        <li class="active"><a href="${ctx}/tools/gameEmail/form?id=${gameEmail.id}">${not empty gameEmail.id?'修改':'申请'}邮件</a>
        </li>
    </shiro:hasPermission>
...
<br/>
<form:form id="inputForm" modelAttribute="gameEmail" action="${ctx}/tools/gameEmail/save" method="post"
    ...
    <div class="control-group" style="display: none" id="trReceiverNames">
        ...
        <div class="controls">
            <button type="button" onclick="openGameUser()">选择用户</button>
            <br>
