...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="game.gm.edit">
			<li class="active"><a href="${ctx}/game/role/gmForm?id=${paramMap.roleName}">${not empty paramMap.roleName?'修改':'添加'}指导员</a></li>
		</shiro:hasPermission>
	...
	<form id="inputForm" action="${ctx}/game/role/saveGm" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input id="serverIds" name="serverIds" value="${paramMap.serverIds}" readonly/><input type="button" class="btn btn-primary" value="选择服务器" onclick="openServer()"></button>
