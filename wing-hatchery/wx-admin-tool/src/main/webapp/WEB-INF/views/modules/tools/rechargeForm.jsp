...
<body>
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="game.recharge.apply">
			<li class="active"><a href="${ctx}/tools/recharge/form?id=${recharge.id}">${not empty recharge.id?'按角色名修改':'按角色名申请'}充值</a></li>
			<li><a href="${ctx}/tools/recharge/roleIdRechargeForm?id=${recharge.id}">${not empty recharge.id?'按角色ID修改':'按角色ID申请'}充值</a></li>
		</shiro:hasPermission>
	</ul><br/>
