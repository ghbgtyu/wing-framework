...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/game/role/levelRanking/">战斗力排行</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<tr><th>角色账号</th><th>角色名</th><th>战斗力</th><th>最大战斗力</th><th>最小战斗力</th><th>升级时间</th></tr>
		<c:forEach items="${page.list}" var="item">
			<tr>
				<td>${item.id}</td>
				<td>${item.name}</td>
				<td>${item.power}</td>
				<td>${item.history_max_power}</td>
				<td>${item.history_min_power}</td>
