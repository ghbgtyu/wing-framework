...
<form:form id="searchForm" modelAttribute="gainPropDetail" action="${ctx}/log/gainProp/" method="post" class="breadcrumb form-search">
    ...
    &nbsp;<input id="btnExport" class="btn btn-primary" type="button" value="导出" onclick="doExport('${ctx}/log/gainProp/export')"/>
     </div>
</form:form>

<table id="contentTable" class="table table-striped table-bordered table-condensed table-hover">
    <thead><tr><th>玩家角色账号</th><th>玩家角色名称</th><th>事件类型</th><th>物品编号</th><th>物品名称</th><th>次数</th><th>时间</th></tr></thead>
    <tbody>
