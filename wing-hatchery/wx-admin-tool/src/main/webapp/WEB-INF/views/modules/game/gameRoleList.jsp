            ...
            <tr>
                ...
                <td>
                    <shiro:hasPermission name="game.role.delete">
                        <a href="${ctx}/game/role/delete?id=${role.id}"
                           onclick="return confirmx('确认要删除该角色吗？', this.href)">删除角色</a>
                    </shiro:hasPermission>
                    <shiro:hasPermission name="game.role.logingame">
                        <a target="_blank"
                           href="${ctx}/game/role/loginGame?userId=${role.name}&serverId=${role.serverId}">登陆游戏</a>
                    </shiro:hasPermission>
