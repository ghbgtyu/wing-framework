...
<form id="searchForm" action="${ctx}/global/platformStatistics/platformOnlineStatistics" method="post"
            ...
            <div style="height: 300px;line-height: 300px">
                ...
                <table class="highchart table"
                    ...
                    <c:forEach items="${onlineTotalPieGraph}" var="item">
                        <tr>
                            <td>${fns:getGamePlatformNameById(item.pid,item.pid)}</td>
                            <td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_acu_percent}"/>">
                                <fmt:formatNumber type="percent" value="${item.p_acu_percent}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
