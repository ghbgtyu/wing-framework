		...
		<c:forEach items="${fileList}" var="sysFile">
			<tr>
				...
				<td>
					...
					<a href="#" onclick="downloadFile('${ctx}/bus/file/downloadFile?id=${sysFile.id}&fileId=${busFile.id}')">下载</a>
					<shiro:hasPermission name="bus:file:manager">
						<a href="${ctx}/bus/file/deleteFile?id=${sysFile.id}&fileId=${busFile.id}" onclick="return confirmx('确认要删除合同文件吗？', this.href)">删除</a>
					</shiro:hasPermission>
				</td>
