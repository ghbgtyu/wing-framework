...
<body>
     <ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/log/propController/propConsumeList">道具消耗日志</a></li>
	 </ul>
	<form id="searchForm" action="${ctx}/log/propController/propConsumeList" method="post" class="breadcrumb form-search">
	    ...
	    &nbsp;<input id="btnExport" class="btn btn-primary" type="button" value="导出" onclick="doExport('${ctx}/log/propController/export')"/>
		</shiro:hasPermission>
	</form>
