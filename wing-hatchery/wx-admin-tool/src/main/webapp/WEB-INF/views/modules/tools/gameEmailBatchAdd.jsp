...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="game.email.edit">
        <li><a href="${ctx}/tools/gameEmail/form?id=${gameEmail.id}">${not empty gameEmail.id?'修改':'申请'}邮件</a></li>
    </shiro:hasPermission>
    <shiro:hasPermission name="game.email.batchadd">
        <li class="active"><a href="${ctx}/tools/gameEmail/batchAdd">申请批量补偿</a></li>
    </shiro:hasPermission>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="gameEmail" enctype="multipart/form-data"
           action="${ctx}/tools/gameEmail/batchSave" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    <tags:message content="${message}"/>
    <%--这里默认不是全服发送isGlobal默认置0--%>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input onclick="openGoodsDialog(0)" id="0" readonly="readonly"> <input type="hidden" name="goodsList[0].id"
                                                                                   id="id0">
            ...
            有效期:<input name="goodsList[0].expireTime" id="expireTime0" readonly="readonly"
                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd H:mm:ss'})">(可选)<br/>

            <input onclick="openGoodsDialog(1)" id="1" readonly="readonly"> <input type="hidden" name="goodsList[1].id"
                                                                                   id="id1">
            ...
            有效期:<input name="goodsList[1].expireTime" id="expireTime1" readonly="readonly"
                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd H:mm:ss'})">(可选)<br/>

            <input onclick="openGoodsDialog(2)" id="2" readonly="readonly"> <input type="hidden" name="goodsList[2].id"
                                                                                   id="id2">
            ...
            有效期:<input name="goodsList[2].expireTime" id="expireTime2" readonly="readonly"
                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd H:mm:ss'})">(可选)<br/>

            <input onclick="openGoodsDialog(3)" id="3" readonly="readonly"> <input type="hidden" name="goodsList[3].id"
                                                                                   id="id3">
            ...
            有效期:<input name="goodsList[3].expireTime" id="expireTime3" readonly="readonly"
                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd H:mm:ss'})">(可选)<br/>

            <input onclick="openGoodsDialog(4)" id="4" readonly="readonly"> <input type="hidden" name="goodsList[4].id"
                                                                                   id="id4">
            ...
            有效期:<input name="goodsList[4].expireTime" id="expireTime4" readonly="readonly"
                       onfocus="WdatePicker({dateFmt:'yyyy-MM-dd H:mm:ss'})">(可选)<br/>
        </div>

        <div class="control-group">
            <label class="control-label">玩家列表:</label>
            <div class="controls">
