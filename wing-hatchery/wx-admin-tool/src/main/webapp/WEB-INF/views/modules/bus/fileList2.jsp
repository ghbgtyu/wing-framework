...
<form id="searchForm" action="${ctx}/bus/file/list2" method="post" class="breadcrumb form-search">
    ...
    -&nbsp;<input type="text" name="createDateEnd" class="input-small" readonly="readonly" id="endDatePicker"
        ...
        <tr>
            ...
            <shiro:hasPermission name="bus:file:upload">
                <td>
                    ...
                    <a href="${ctx}/bus/file/remove?id=${busFile.id}&fileId=${busFile.fileId}"
                       onclick="return confirmx('移除后合同将变为预处理状态，确认要把合同移除吗？', this.href)">移除</a>
                </td>
            </shiro:hasPermission>
