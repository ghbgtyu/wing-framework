...
<form id="searchForm" action="${ctx}/global/platformStatistics/platformStatistics" method="post"
                ...
                <table class="highchart table"
                    ...
                    <c:forEach items="${statisticsList}" var="item">
                        <tr>
                            ...
                            <td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_income}"/>">
                                <fmt:formatNumber type="percent" value="${item.p_income}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
    ...
    <div class="row-fluid">
        <div class="span6 panel panel-primary">
            ...
            <div style="height: 300px;line-height: 300px">
                ...
                <table class="highchart table"
                       data-graph-container=".highchart-dru-pie" data-graph-type="pie" data-graph-pie-show-in-legend="1"
                    ...
                    <c:forEach items="${statisticsList}" var="item">
                        <tr>
                            <td>${fns:getGamePlatformNameById(item.pid,item.pid)}</td>
                            <td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_dru}"/>">
                                <fmt:formatNumber type="percent" value="${item.p_dru}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
    ...
    <div class="row-fluid">
        <div class="span6 panel panel-primary">
            ...
            <div style="height: 300px;line-height: 300px">
                ...
                <table class="highchart table"
                       data-graph-container=".highchart-consume-pie" data-graph-type="pie"
                       data-graph-pie-show-in-legend="1" data-graph-datalabels-enabled="1" style="display: none">
                    ...
                    <c:forEach items="${statisticsList}" var="item">
                        <tr>
                            <td>${fns:getGamePlatformNameById(item.pid,item.pid)}</td>
                            <td data-graph-name="${fns:getGamePlatformNameById(item.pid,item.pid)} : <fmt:formatNumber type="percent" value="${item.p_consume}"/>">
                                <fmt:formatNumber type="percent" value="${item.p_consume}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
