...
<div class="container">
    ...
    <div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>">
        ...
        <label id="loginError"
               class="error"><%=error == null ? "" : "com.mokylin.cabal.modules.sys.security.CaptchaException".equals(error) ? "验证码错误, 请重试." : "用户或密码错误, 请重试." %>
        </label>
    </div>
    <div id="login-wraper">
...
<footer class="white navbar-fixed-bottom">
    ...
    <a href="https://github.com/cabal" target="_blank">Cabal</a> ${fns:getConfig('version')}
</footer>
</body>
</html>