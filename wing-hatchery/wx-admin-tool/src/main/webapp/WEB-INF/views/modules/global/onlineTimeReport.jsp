...
<form id="searchForm" action="${ctx}/global/onlineTime/onlineTimeReport" method="post" class="breadcrumb form-search">
    ...
    <label>时间 ：</label>
    <input name="createDateStart" id="createTimeStart" maxlength="50" value="${paramMap.createDateStart}"
        ...
        <div class="span6 panel panel-primary">
            ...
            <div style="height: 300px;line-height: 300px">
                ...
                <table class="highchart table"
                       data-graph-container=".highchart-userRate" data-graph-type="pie"
                    ...
                    <c:forEach items="${onlineTimeArea}" var="item">
                        <tr>
                            <td>${item.time}分钟</td>
                            <td data-graph-name='${item.time} 分钟 : <fmt:formatNumber type="percent" value="${item.num/sumNum}"/>'>
                                <fmt:formatNumber type="percent" value="${item.num/sumNum}"/></td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
