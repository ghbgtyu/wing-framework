...
<script src="${ctxStatic}/upload/bootstrap-file/js/plugins/piexif.min.js" type="text/javascript"></script>
<!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
This must be loaded before fileinput.min.js -->
<script src="${ctxStatic}/upload/bootstrap-file/js/plugins/sortable.min.js" type="text/javascript"></script>
<!-- purify.min.js is only needed if you wish to purify HTML content in your preview for
HTML files. This must be loaded before fileinput.min.js -->
<script src="${ctxStatic}/upload/bootstrap-file/js/plugins/purify.min.js" type="text/javascript"></script>
<!-- bootstrap.min.js below is needed if you wish to zoom and preview file content in a detail modal
dialog. bootstrap 4.x is supported. You can also use the bootstrap js 3.3.x versions. -->
<script src="${ctxStatic}/upload/bootstrap-file/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
<!-- the main fileinput plugin file -->
<script src="${ctxStatic}/upload/bootstrap-file/js/fileinput.min.js"></script>

<script src="${ctxStatic}/upload/bootstrap-file/js/locales/zh.js"></script>
...
<script src="${ctxStatic}/upload/base.js" type="text/javascript"></script>