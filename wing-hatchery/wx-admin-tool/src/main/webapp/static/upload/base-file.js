...
(function ($, window, document, undefined) {
    ...
    BaseFile.prototype.default = {
        ...
        fileinput: {
            language: 'zh',
            uploadUrl: BASE + "/bus/file/uploadMultipleFile",
            deleteUrl:BASE+"/bus/file/delete",
            uploadAsync:false,
    ...
    BaseFile.prototype.getFileIconSettings = function () {
        var self = this;
        ajaxPost(BASE + "/bus/file/icons", null, function (icons) {
    ...
    BaseFile.prototype.downloadHandler=function(fileobj){
        ...
        objs.on("click",function(){
            //点击下载
            window.location.href=BASE+"/bus/file/download/"+$(this).data("key");
        });
    }
    /**
    ...
    BaseFile.prototype.getFileResult=function(fileIds){
        var ret=null;
        ajaxPost(BASE+"/bus/file/getFiles",{fileIds:fileIds},function(result){
            ret=result;
        });
        return ret;
    };
