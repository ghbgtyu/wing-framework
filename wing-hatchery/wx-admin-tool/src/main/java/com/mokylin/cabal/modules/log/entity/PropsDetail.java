...
public class PropsDetail extends MybatisBaseBean  {
	...
	@ExcelField(title="事件类型", align=2, sort=50)
	...
	@ExcelField(title="角色ID", align=2, sort=20)
	...
	@ExcelField(title="道具变化数量", align=2, sort=70)
	...
	@ExcelField(title="道具变化前的值", align=2, sort=80)
	...
	@ExcelField(title="道具变化后的值", align=2, sort=90)
	...
	@ExcelField(title="道具变化", align=2, sort=50)
	...
	@ExcelField(title="时间", align=2, sort=100)
	...
	@ExcelField(title="资源线", align=2, sort=30)
	...
	@ExcelField(title="活动面板", align=2, sort=40)
