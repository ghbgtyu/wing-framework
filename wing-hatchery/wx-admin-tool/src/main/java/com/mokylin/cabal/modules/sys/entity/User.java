...
import com.mokylin.cabal.common.utils.excel.fieldtype.RoleListType;
...
public class User extends IdEntity<User> {
    ...
    private List<String> roleUserIdList = new ArrayList();//有相同角色权限的所有userId
...
//	}
    ...
    @Transient
    public List<String> getRoleUserIdList() {
        return roleUserIdList;
    }

    public void setRoleUserIdList(List<String> roleUserIdList) {
        this.roleUserIdList = roleUserIdList;
    }
}