...
public class SystemService extends BaseService {
    ...
    public GamePlatform getGamePlatform(String id) {
...
//		}
    ...
    @Transactional(readOnly = false)
    public void deleteGamePlatform(String id) {
        gamePlatformDao.deleteById(id);
        UserUtils.removeCache(UserUtils.CACHE_GAME_PLATFORM_LIST);
    }
    ...
    public GamePlatform findGamePlatformByName(String name) {
        return gamePlatformDao.findByName(name);
    }

    public GamePlatform findGamePlatformByPid(String pid) {
        return gamePlatformDao.findByPid(pid);
    }
    ...
    public List<GamePlatform> findAllGamePlatform() {
        return UserUtils.getAllGamePlatform();
    }
